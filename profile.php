...
<div class="form-group">
	...
	<label class="col-sm-2 control-label">GPS Address<span style="color:red">*</span></label>
	<div class="col-sm-4">
	<input type="address" name="gps" class="form-control" required value="<?php echo htmlentities($result->mobile);?>">
	</div>
</div>
